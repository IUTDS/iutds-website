...
const TopBanner = () => {
  return (
    <div className="flex flex-col md:flex-row items-center container mx-auto min-w-fit">
      <div className="w-full relative">
        ...
        />
        <div className="md:absolute md:top-1/2 md:right-0 md:transform -translate-y-10 md:-translate-x-32 text-center md:text-right">
